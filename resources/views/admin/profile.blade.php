...
<div class="page-wrapper">
				...
				<div class="container">
					<div class="main-body">
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="card">
								<form  id="formSubmit" action="{{url('admin/profile')}}"   enctype="multipart/form-data">
								@csrf
									<div class="card-body">
										<div class="row mb-3">
											<div class="col-sm-3">
									...
									<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control" name="inst_link"  value="{{Auth::user()->inst_link}}">
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
    ...
    $(document).ready(function(f) {
        $('#formSubmit').on('submit',(function(e) {
			...
			var html ='<button class="btn btn-primary" type="button" disabled=""> <span class="spinner-border spinner-border-sm" arole="status" aria-hidden="true"></span><span class="visually-hidden">Loading...</span></button>';
