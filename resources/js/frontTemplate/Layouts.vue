<template>
     ...
     <div id="preloader">
        ...
        <header class="header-style-two">
                        ...
                        <div class="col-12">
                            ...
                            <div class="menu-wrap">
                                <nav class="menu-nav show">
                                    <div class="logo">
                                        <a href="index.html" class="main-logo"><img src="./../asset/img/logo/fw_logo.png" alt="Logo"></a>
                                        <a href="index.html" class="sticky-logo"><img src="./../asset/img/logo/logo.png" alt="Logo"></a>
                                    </div>
                                        ...
                                        <ul class="navigation">
                                            <li class="active menu-item-has-children has--mega--menu"><a href="#">Home</a>
                                                <ul class="mega--menu--wrap scroll">
                                                    <li>
                                                        <a href="index.html">
                                                            <span class="img"><img src="./../asset/img/home-demo/home_01.jpg" alt=""></span>
                                                            <span class="text">Home style One</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="index-2.html">
                                                            <span class="img"><img src="./../asset/img/home-demo/home_02.jpg" alt=""></span>
                                                            <span class="text">Home style Two</span>
                                                        </a>
                                                    </li>
                                                    <li class="active">
                                                        <a href="index-3.html">
                                                            <span class="img"><img src="./../asset/img/home-demo/home_03.jpg" alt=""></span>
                                                            <span class="text">Home style Three</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="index-4.html">
                                                            <span class="img"><img src="./../asset/img/home-demo/home_04.jpg" alt=""></span>
                                                            <span class="text">Home style four</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="index-5.html">
                                                            <span class="img"><img src="./../asset/img/home-demo/home_05.jpg" alt=""></span>
                                                            <span class="text">Home style five</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="index-6.html">
                                                            <span class="img"><img src="./../asset/img/home-demo/home_06.jpg" alt=""></span>
                                                            <span class="text">Home style six</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="index-7.html">
                                                            <span class="img"><img src="./../asset/img/home-demo/home_07.jpg" alt=""></span>
                                                            <span class="text">Home style seven</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="index-8.html">
                                                            <span class="img"><img src="./../asset/img/home-demo/home_08.jpg" alt=""></span>
                                                            <span class="text">Home style eight</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="index-9.html">
                                                            <span class="img"><img src="./../asset/img/home-demo/home_09.jpg" alt=""></span>
                                                            <span class="text">Home style nine</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="has--mega--menu"  v-for="item in headerCategories" :key="item.id">
                                                <a href="#">{{ item.name }}</a>
                                                <ul class="mega-menu">
                                            ...
                                            <li class="header-shop-cart"><a href="#"><i class="flaticon-shopping-bag"></i><span>0</span></a>
                                                <ul class="minicart">
                                                    <li class="d-flex align-items-start">
                                                        <div class="cart-img">
                                                            <a href="#"><img src="./../asset/img/product/cart_p01.jpg" alt=""></a>
                                                        </div>
                                                    ...
                                                    <li class="d-flex align-items-start">
                                                        <div class="cart-img">
                                                            <a href="#"><img src="./../asset/img/product/cart_p02.jpg" alt=""></a>
                                                        </div>
                                                        <div class="cart-content">
            ...
            <!-- off-canvas-start -->
            <div class="sidebar-toggle-btn"><a href="#" class="navSidebar-button"><img src="./../asset/img/icon/sidebar_toggle_icon.png" alt=""></a></div>
